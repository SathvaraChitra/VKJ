...
class Temp_save_order extends GetView<Temp_save_orderController> {
  static String pageId = "/Sync_order";

  const Temp_save_order({Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        leading:const Icon(
          Icons.arrow_back, color: Colors.grey,size: 25,),
        title: const Text("Temp Save Orders", style:TextStyle(color: Colors.grey),),
        actions: const [
          Padding(
